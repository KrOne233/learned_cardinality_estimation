...
def load_and_encode_train_data(filename_queries, min_max_file, num_queries, num_materialized_samples):
    file_name_queries = filename_queries  # "data/imdb/title_sql"
    file_name_column_min_max_vals = min_max_file  # "data/imdb/column_min_max_vals.csv"
...
def get_train_datasets(filename_queries, min_max_file, num_queries, num_materialized_samples):
    dicts, column_min_max_vals, min_val, max_val, labels_train, labels_test, max_num_joins, max_num_predicates, train_data, test_data = load_and_encode_train_data(
        filename_queries, min_max_file, num_queries, num_materialized_samples)
