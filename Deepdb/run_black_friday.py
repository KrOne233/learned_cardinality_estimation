...
dataset = 'black_friday_purchase'

if dataset == 'black_friday_purchase':
    ...
    # Generate schema
    csv_path = 'data/Black_Friday'
    table_csv_path = csv_path + '/{}.csv'
    schema = gen_black_friday_purchase_schema(table_csv_path)

    # Generate HDF files for simpler sampling
    hdf_path = 'data/Black_Friday/hdf_files'
    ...
    ensemble_path = 'data/Black_Friday/ensembles'
    ...
    if ensemble_strategy == 'single':
        ...
        pairwise_rdc_path = 'data/Black_Friday/ensembles/pairwise_rdc.pkl'
    ...
    query_file = 'data/Black_Friday/deepdb_sql.sql'
    true_cardinalities_path = 'data/Black_Friday/deepdb_true_cardinalities.csv'
    target_csv_path = 'results/result_deepdb_black_friday_purchase.csv'
