...
from Deepdb.rspn.structure.leaves import IdentityNumericLeaf, Categorical
...
def learn_mspn(
    ...
    from Deepdb.rspn.learning.structure_learning import get_next_operation, learn_structure
