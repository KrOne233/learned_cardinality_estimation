...
i = 1
deepdb_file_dir = 'data/gpu_game_fps/2_col_sql'
deepdb_sql_dir = 'data/gpu_game_fps/2_col_sql'
while i<38:
    sql_file_csv = f'data/gpu_game_fps/2_col_sql/fps_2col_{i}_test.csv'
